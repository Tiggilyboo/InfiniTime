...
constexpr int16_t MinuteLength = 85;
constexpr int16_t SecondLength = 85;
...
WatchFaceAnalog::WatchFaceAnalog(Pinetime::Applications::DisplayApp* app,
  ...
  lv_obj_set_size(stepsMeter, 240, 240);
  ...
  lv_style_set_line_width(&minute_line_style, LV_STATE_DEFAULT, 6);
